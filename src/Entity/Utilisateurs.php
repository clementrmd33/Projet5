...
class Utilisateurs implements UserInterface, \Serializable
{
     ...
     * @Assert\Length(min="3", minMessage="L'identifiant doit comporter 3 caracteres minimum")
     */
    private $username;

    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Length(min="8", minMessage="Le mot de passe doit comporter 8 caracteres minimum")
     */
    private $password;
    /**
